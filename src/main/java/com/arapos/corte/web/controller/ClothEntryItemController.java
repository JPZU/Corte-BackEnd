...
public class ClothEntryItemController {
    ...
    @PutMapping("/update")
    public ResponseEntity<ClothEntryItemResponseDTO> update(@Valid @RequestBody CreateClothEntryItemDTO createClothEntryItemDTO) {
        return ResponseEntity.ok(clothEntryItemService.update(createClothEntryItemDTO));
    }
